...
- Release checklist: `docs/releases/mvp-release-checklist.md`
...
cargo build -p canopy-lib
cargo build -p canopy-bin
...
cargo nextest run -p canopy-lib
...
cargo add -p canopy-lib <crate_name>
